...
public class SDK {
    ...
    public static class Builder {
         ...
         * @return The builder instance.
         */
        public Builder security(com.tigrisdata.tigris_core.models.shared.Security security) {
    ...
    private SDK(SDKConfiguration sdkConfiguration) {
        ...
        this.namespace = new Namespace(sdkConfiguration);
        this.user = new User(sdkConfiguration);
        this.project = new Project(sdkConfiguration);
        this.appKey = new AppKey(sdkConfiguration);
        this.cache = new Cache(sdkConfiguration);
