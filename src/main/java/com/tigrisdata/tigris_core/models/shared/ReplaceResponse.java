...
public class ReplaceResponse {
     ...
     * an array returns the value of the primary keys.
     */
    public ReplaceResponse withKeys(java.util.List<String> keys) {
        Utils.checkNotNull(keys, "keys");
     ...
     * an array returns the value of the primary keys.
     */
    public ReplaceResponse withKeys(Optional<? extends java.util.List<String>> keys) {
        Utils.checkNotNull(keys, "keys");
        this.keys = keys;
        return this;
    }
     ...
     * Has metadata related to the documents stored.
     */
    public ReplaceResponse withMetadata(Optional<? extends ResponseMetadata> metadata) {
        Utils.checkNotNull(metadata, "metadata");
        this.metadata = metadata;
        return this;
    }
     ...
     * an enum with value set as "replaced"
     */
    public ReplaceResponse withStatus(Optional<? extends String> status) {
        Utils.checkNotNull(status, "status");
        this.status = status;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        ReplaceResponse other = (ReplaceResponse) o;
        return 
    ...
    public String toString() {
        return Utils.toString(ReplaceResponse.class,
                "keys", keys,
                "metadata", metadata,
                "status", status);
    }
