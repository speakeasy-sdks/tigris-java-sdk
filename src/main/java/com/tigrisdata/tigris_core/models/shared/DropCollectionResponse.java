...
public class DropCollectionResponse {
     ...
     * A detailed response message.
     */
    public DropCollectionResponse withMessage(Optional<? extends String> message) {
        Utils.checkNotNull(message, "message");
        this.message = message;
        return this;
    }
     ...
     * An enum with value set as "dropped".
     */
    public DropCollectionResponse withStatus(Optional<? extends String> status) {
        Utils.checkNotNull(status, "status");
        this.status = status;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        DropCollectionResponse other = (DropCollectionResponse) o;
        return 
    ...
    public String toString() {
        return Utils.toString(DropCollectionResponse.class,
                "message", message,
                "status", status);
    }
    ...
    public final static class Builder {
        ...
        public DropCollectionResponse build() {
