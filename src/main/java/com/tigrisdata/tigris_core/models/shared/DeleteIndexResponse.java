...
public class DeleteIndexResponse {
     ...
     * A detailed response message.
     */
    public DeleteIndexResponse withMessage(Optional<? extends String> message) {
        Utils.checkNotNull(message, "message");
        this.message = message;
        return this;
    }
     ...
     * An enum with value set as "deleted".
     */
    public DeleteIndexResponse withStatus(Optional<? extends String> status) {
        Utils.checkNotNull(status, "status");
        this.status = status;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        DeleteIndexResponse other = (DeleteIndexResponse) o;
        return 
    ...
    public String toString() {
        return Utils.toString(DeleteIndexResponse.class,
                "message", message,
                "status", status);
    }
