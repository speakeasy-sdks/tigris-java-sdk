...
public class CreateOrUpdateIndexResponse {
     ...
     * A detailed response message.
     */
    public CreateOrUpdateIndexResponse withMessage(Optional<? extends String> message) {
        Utils.checkNotNull(message, "message");
        this.message = message;
        return this;
    }
     ...
     * An enum with value set as "created"
     */
    public CreateOrUpdateIndexResponse withStatus(Optional<? extends String> status) {
        Utils.checkNotNull(status, "status");
        this.status = status;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        CreateOrUpdateIndexResponse other = (CreateOrUpdateIndexResponse) o;
        return 
    ...
    public String toString() {
        return Utils.toString(CreateOrUpdateIndexResponse.class,
                "message", message,
                "status", status);
    }
    ...
    public final static class Builder {
        ...
        public CreateOrUpdateIndexResponse build() {
            return new CreateOrUpdateIndexResponse(
                message,
                status);
        }
    }
