...
public class DeleteDocumentResponse {
     ...
     * An array of statuses of all the documents received in the request. Order is same as it is received in the request. Each item of this array has an “id” and “error” key. Id is set as document id and error will be null in case of success, otherwise error is set with an error code and message.
     */
    public DeleteDocumentResponse withStatus(java.util.List<DocStatus> status) {
        Utils.checkNotNull(status, "status");
     ...
     * An array of statuses of all the documents received in the request. Order is same as it is received in the request. Each item of this array has an “id” and “error” key. Id is set as document id and error will be null in case of success, otherwise error is set with an error code and message.
     */
    public DeleteDocumentResponse withStatus(Optional<? extends java.util.List<DocStatus>> status) {
        Utils.checkNotNull(status, "status");
        this.status = status;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        DeleteDocumentResponse other = (DeleteDocumentResponse) o;
        return 
    ...
    public String toString() {
        return Utils.toString(DeleteDocumentResponse.class,
                "status", status);
    }
