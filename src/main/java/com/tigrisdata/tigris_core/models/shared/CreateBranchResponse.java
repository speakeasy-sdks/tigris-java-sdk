...
public class CreateBranchResponse {
     ...
     * A detailed response message.
     */
    public CreateBranchResponse withMessage(Optional<? extends String> message) {
        Utils.checkNotNull(message, "message");
        this.message = message;
        return this;
    }
     ...
     * An enum with value set as "created".
     */
    public CreateBranchResponse withStatus(Optional<? extends String> status) {
        Utils.checkNotNull(status, "status");
        this.status = status;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        CreateBranchResponse other = (CreateBranchResponse) o;
        return 
    ...
    public String toString() {
        return Utils.toString(CreateBranchResponse.class,
                "message", message,
                "status", status);
    }
