...
public class RollbackTransactionRequest {
     ...
     * Optionally specify a database branch name to perform operation on
     */
    public RollbackTransactionRequest withBranch(Optional<? extends String> branch) {
        Utils.checkNotNull(branch, "branch");
        this.branch = branch;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        RollbackTransactionRequest other = (RollbackTransactionRequest) o;
        return 
    ...
    public String toString() {
        return Utils.toString(RollbackTransactionRequest.class,
                "branch", branch);
    }
