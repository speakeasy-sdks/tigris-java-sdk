...
public class CommitTransactionResponse {
     ...
     * Status of commit transaction operation.
     */
    public CommitTransactionResponse withStatus(Optional<? extends String> status) {
        Utils.checkNotNull(status, "status");
        this.status = status;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        CommitTransactionResponse other = (CommitTransactionResponse) o;
        return 
    ...
    public String toString() {
        return Utils.toString(CommitTransactionResponse.class,
                "status", status);
    }
