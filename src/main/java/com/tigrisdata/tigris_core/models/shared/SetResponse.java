...
public class SetResponse {
     ...
     * A detailed response message.
     */
    public SetResponse withMessage(Optional<? extends String> message) {
        Utils.checkNotNull(message, "message");
        this.message = message;
        return this;
    }
     ...
     * An enum with value set as "set"
     */
    public SetResponse withStatus(Optional<? extends String> status) {
        Utils.checkNotNull(status, "status");
        this.status = status;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        SetResponse other = (SetResponse) o;
        return 
    ...
    public String toString() {
        return Utils.toString(SetResponse.class,
                "message", message,
                "status", status);
    }
