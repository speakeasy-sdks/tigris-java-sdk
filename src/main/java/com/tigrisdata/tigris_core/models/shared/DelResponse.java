...
public class DelResponse {
     ...
     * A detailed response message.
     */
    public DelResponse withMessage(Optional<? extends String> message) {
        Utils.checkNotNull(message, "message");
        this.message = message;
        return this;
    }
     ...
     * An enum with value set as "deleted" or "not_found"
     */
    public DelResponse withStatus(Optional<? extends String> status) {
        Utils.checkNotNull(status, "status");
        this.status = status;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        DelResponse other = (DelResponse) o;
        return 
    ...
    public String toString() {
        return Utils.toString(DelResponse.class,
                "message", message,
                "status", status);
    }
