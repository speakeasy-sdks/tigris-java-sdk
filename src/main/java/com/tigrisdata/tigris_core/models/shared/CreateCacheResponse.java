...
public class CreateCacheResponse {
     ...
     * A detailed response message.
     */
    public CreateCacheResponse withMessage(Optional<? extends String> message) {
        Utils.checkNotNull(message, "message");
        this.message = message;
        return this;
    }
     ...
     * An enum with value set as "created"
     */
    public CreateCacheResponse withStatus(Optional<? extends String> status) {
        Utils.checkNotNull(status, "status");
        this.status = status;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        CreateCacheResponse other = (CreateCacheResponse) o;
        return 
    ...
    public String toString() {
        return Utils.toString(CreateCacheResponse.class,
                "message", message,
                "status", status);
    }
