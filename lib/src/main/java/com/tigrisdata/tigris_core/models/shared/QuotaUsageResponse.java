...
public class QuotaUsageResponse {
     ...
     */
    @JsonInclude(Include.NON_ABSENT)
    @JsonProperty("ReadUnitsThrottled")public Long readUnitsThrottled;
     ...
     */
    @JsonInclude(Include.NON_ABSENT)
    @JsonProperty("StorageSizeThrottled")public Long storageSizeThrottled;
     ...
     */
    @JsonInclude(Include.NON_ABSENT)
    @JsonProperty("WriteUnitsThrottled")public Long writeUnitsThrottled;
