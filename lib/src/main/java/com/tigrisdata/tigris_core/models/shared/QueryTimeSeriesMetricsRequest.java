...
public class QueryTimeSeriesMetricsRequest {
    ...
    @JsonProperty("additionalFunctions")public AdditionalFunction[] additionalFunctions;
    ...
    @JsonInclude(Include.NON_ABSENT)
    @JsonProperty("db")public String db;
    ...
    @JsonInclude(Include.NON_ABSENT)
    @JsonProperty("function")public QueryTimeSeriesMetricsRequestFunctionEnum function;
    ...
    @JsonInclude(Include.NON_ABSENT)
    @JsonProperty("metric_name")public String metricName;
    ...
    @JsonInclude(Include.NON_ABSENT)
    @JsonProperty("quantile")public Float quantile;
    ...
    @JsonInclude(Include.NON_ABSENT)
    @JsonProperty("space_aggregated_by")public String[] spaceAggregatedBy;
    ...
    @JsonInclude(Include.NON_ABSENT)
    @JsonProperty("space_aggregation")public QueryTimeSeriesMetricsRequestSpaceAggregationEnum spaceAggregation;
    ...
    @JsonInclude(Include.NON_ABSENT)
    @JsonProperty("tigris_operation")public QueryTimeSeriesMetricsRequestTigrisOperationEnum tigrisOperation;
