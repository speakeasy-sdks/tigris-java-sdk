...
public class ImportRequest {
    ...
    @JsonProperty("autogenerated")public String[] autogenerated;
     ...
     */
    @JsonInclude(Include.NON_ABSENT)
    @JsonProperty("create_collection")public Boolean createCollection;
     ...
     */
    @JsonInclude(Include.NON_ABSENT)
    @JsonProperty("options")public ImportRequestOptions options;
